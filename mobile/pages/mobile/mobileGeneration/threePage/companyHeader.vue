...
<div>
  <div class="header">
      ...
      <div class="company">
        <div class="company_name"><span>{{ companyInfo.companyName }}</span><span>统一社会信用代码:{{ companyInfo.companyNo }}</span></div>
        <div class="companyhead">
          <div>
            <img :src="companyLogo" alt="企业头像">
          </div>
      ...
      <div class="unitinfo">
          <div class="unitinfo_top"><span>守信经营承诺单位</span><span>公示期：预览样例</span></div>
          <div class="unitinfo_box">
            <div class="unitinfo_center">
              <span v-for="(item,index) in paibianList" :key="index">
                {{ item.title }}
              </span>
            </div>
          </div>
...
const props = defineProps(['companyInfo','companydecList','paibianList','companyLogo','browser'])

const {companyInfo,companydecList,paibianList,companyLogo,browser} = props || {}
